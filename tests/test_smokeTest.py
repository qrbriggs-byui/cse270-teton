...
class TestSmokeTest():
  ...
  def test_homePage(self):
    self.driver.get("https://qrbriggs-byui.github.io/cse270-course/teton/1.5/index.html")
    self.driver.set_window_size(1153, 1040)
  ...
  def test_joinPage(self):
    ...
    self.driver.find_element(By.NAME, "lname").send_keys("McDonald")
    self.driver.find_element(By.NAME, "bizname").send_keys("McDonald\'s Restaurant")
    self.driver.find_element(By.NAME, "biztitle").send_keys("Mascot")
